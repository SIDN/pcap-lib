...
public interface Buffer {
   ...
   * 
   * @param buffer the buffer that you want to add to head of internal buffers.
   */
   ...
   * 
   * @param buffer the buffer that you want to add to end of internal buffers.
   */
   ...
   * 
   * @param buffer the byte buffer that you want to add to head of internal buffers.
   */
   ...
   * 
   * @param buffer the byte buffer that you want to add to end of internal buffers.
   */
   ...
   * 
   * @return a byte
   * @throws BufferUnderflowException if position met end of buffers.
   */
   ...
   * Get string from current position. Position will be increased.
   * 
   * @param length the string length that you want to read.
   * @param charsetName the charset name for decoding.
   * @return string data
   * @throws BufferUnderflowException if position met end of buffers.
   */
   ...
   * 
   * @param buffer the output buffer
   * @param offset the index of the first byte to fill
   ...
   * 
   * @param target the byte pattern that you want to search for.
   * @return the offset from current position, first offset of the target pattern. for example, if
   *         you call bytesBefore('\r\n') for 'hello\r\n', it will return 5.
   */
